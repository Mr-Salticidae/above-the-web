...
export const games = [
  ...
  },
  {
    ...
    title: 'TK 中英文字幕转换器',
    tagline: '一份字幕，两种模式，剪映直接吃',
    desc: '语音识别吐出来的长字幕，按剪映里那一行真正能放下的像素宽度自动拆条：英文 TK 格式（不拆单词、只大写首字母、中文自动删）与中文智能分词（一个字不删、闭合标点不落行首）双模式互不串味。保留原起止时间、自动重编号，转换前后全量词元校验，对不上就停手不覆盖。Windows 免安装、不联网。',
    tags: ['剪辑工具', '蒙眼剪辑法', '字幕'],
    path: '/tk-subtitle/',
    status: '免费下载 · Windows',
    emoji: '💬',
  ...
  },
  {
    ...
    desc: '一个 Socratic 助产式对话工具：通过提问和引导，帮你理清思路、发现盲区、找到自己的答案。支持知识解答、学习探索、情绪反思、创意构思、深度调研五种模式，用加粗标记核心观点。这套助产法现已入驻笔记页的查笔记小助手「小织」——问题还没成形，她先帮你把它接生出来。',
